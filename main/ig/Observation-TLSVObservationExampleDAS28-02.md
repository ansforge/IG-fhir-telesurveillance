# TLSVObservationExampleDAS28-02 - Guide d'implémentation de la télésurveillance v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **TLSVObservationExampleDAS28-02**

## Example Observation: TLSVObservationExampleDAS28-02
...
```json
{
  ...
  "id" : "TLSVObservationExampleDAS28-02",
  "meta" : {
    "profile" : [
    ...
    "coding" : [
      {
        ...
        "code" : "442687006",
        "display" : "Swollen 28 joint count"
      }
    ]
  },
  "subject" : {
